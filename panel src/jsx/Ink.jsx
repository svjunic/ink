...
$._ext_INK = {
  ...
  measureX : function( targetLayer, targetLayerInkFolder ) 
  {
    ...
    if ( this.settings.printUnits == "on" ) {
      ...
      // NOTE: extend sv.junic
      if ( true ) {
        measureTxt = measureTxt + "\r" + ( parseInt( this.theLayerBounds.w.toString(), 10 ) / 2 ).toString() + "px";
      }
    }
    else {
  ...
  measureY : function( targetLayer, targetLayerInkFolder ) 
  {
    ...
    if ( this.settings.printUnits == "on" ) 
    {
      ...
      // NOTE: extend sv.junic
      if ( true ) {
        measureTxt = measureTxt + "\r" + ( parseInt( this.theLayerBounds.h.toString(), 10 ) / 2 ).toString() + "px";
      }
    }
    else 
    {
